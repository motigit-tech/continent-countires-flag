package com.quest.continents.country.flag.poc.util;
...
public class StringUtil {
    ...
    /**
     * This method will append zero's provided string and the total length of
     * the string with Zero's.
     *
     * @param strval
     *            Actual string to which zero to be padded.
     * @param columnLen
     *            Actual length after the string with append Zero's.
     ...
     *            Actual string to which zero to be padded.
     * @param columnLen
     *            Actual length after the string with appended Zero's.
    ...
    /**
     * This method checks if given string is null/blank or not.It returns true
     * if the string is null/blank else it return false.
     *
     * @param str
     *            string - input string
